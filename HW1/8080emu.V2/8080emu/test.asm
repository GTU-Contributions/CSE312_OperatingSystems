...
begin:
	...
	LXI B, 400H			; Initialize B with 400H/1024D
						; Read the string into address space
						; starting from 400H/1024D
	MVI A, READ_STR		; Store the OS call code to A
	call GTU_OS			; Call the OS
	MVI A, PRINT_STR	; Store the OS call code to A
	call GTU_OS			; Call the OS
	
	LXI B, 200H			; Initialize B with 200H/512D
						; Read into 200H/512D address
